...
# To build a Shiny app with Plotly on ARM86 architecture, you need to use a base image compatible with ARM. The Rocker project provides ARM-compatible images. You can use rocker/r-ver:4.0.5 as your base image and install Shiny Server manually.

# Create a new directory and add an app.R file with the same content from the previous example using Plotly.

# Now, create a Dockerfile to build the Shiny app image:
...
# ui <- fluidPage(
#   titlePanel("Simple Line Plot with Plotly"),
#   mainPanel(
...
initial_date="2017-01-01" #year(initial_date)

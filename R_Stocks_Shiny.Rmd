...
initial_date="2007-01-01" #year(initial_date)
...
df_inflation$in_2020_dollars_factor <- adjust_for_inflation(nominal_prices, Year, "US", to_date = (year(ending_date)-2)) ###PriceR###

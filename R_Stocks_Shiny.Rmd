...
##### tabpanel -> Stock Analysis ##### 
       ...
       output$Company_Info_ROA <-renderPlotly({
                 ...
                 yaxis = list(title = 'ROA (%)'), legend = list(title=list(text='<b> Date </b>')))
        })                
       ...
       output$Company_Info_ROIC <-renderPlotly({
                 ...
                 yaxis = list(title = 'ROIC (%)'), legend = list(title=list(text='<b> Date </b>')))
        })    
       ...
       output$Company_Info_NetMargin <-renderPlotly({
                 ...
                 yaxis = list(title = 'Net Margin (%)'), legend = list(title=list(text='<b> Date </b>')))
        })                        
 ...
 ##### tabpanel -> Dividend Analysis #####                                    
  ### Dataframes ###
      ...
      ### GRAPHS ###
         ...
         yaxis = list(title = 'Payout Ratio (%)'), legend = list(title=list(text='<b> Date </b>')))
            })
            ...
            output$Company_Info3 <-renderPlotly({
                 ...
                 yaxis = list(title = 'EBITDA Margin (%)'), legend = list(title=list(text='<b> Date </b>')))
            })
             ...
             output$Company_Info2 <-renderPlotly({
                   ...
                   yaxis = list(title = 'Gross Margin (%)'), legend = list(title=list(text='<b> Date </b>')))
            })
              ...
              output$Company_Info4 <-renderPlotly({
                   ...
                   yaxis = list(title = 'EV/EBITDA (%)'), legend = list(title=list(text='<b> Date </b>')))
            })
            ...
            output$Company_Info5 <-renderPlotly({
             ...
             yaxis = list(title = 'Debt/Assets Evolution (%)'), legend = list(title=list(text='<b> Date </b>')))
            })
...
df_inflation$money_input_infl_year <- input$money_in_portf/df_inflation$in_2020_dollars_factor 
    ...
    plot_ly(DCA_df_divs_interactive(), labels = ~ticker, values = ~div_cash_flow, type = 'pie')%>% 
                layout(title = 'Dividend Cash Flow split TODAY*',
         ...
         yaxis = list(showgrid = FALSE, zeroline = FALSE, showticklabels = FALSE)
               ...
               output$YoC_hist <- renderPlotly({
                  ...
                  plot_ly() %>%
                            add_trace(data= dfz_interactive(), x = ~yearz, y = ~historical_yield, name = "Portfolio Historical Yield", type = "bar") %>%
